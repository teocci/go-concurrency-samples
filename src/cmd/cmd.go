...
func Execute() {
	app := &cli.App{
		...
		Usage: "Unzip a file and process the data inside",
		UsageText: "[go-concurrency-samples -f data.zip]\n 	Unzip a file and process its data",
		Version: version + build,
		Flags: []cli.Flag{
			&cli.BoolFlag{Name: "verbose", Aliases: []string{"-v"}, Destination: &verbose, Value: false, Usage: "verbose"},
			&cli.BoolFlag{Name: "compress", Aliases: []string{"-c"}, Destination: &compress, Value: false, Usage: "compress result to zip"},
