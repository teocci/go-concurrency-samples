...
type RTT struct {
	...
	Lat             float32 `json:"drone_lat" csv:"drone_lat" name:"drone_lat"`
	Long            float32 `json:"drone_long" csv:"drone_lat" name:"drone_lat"`
	Alt             float32 `json:"drone_alt" csv:"drone_lat" name:"drone_lat"`
	Roll            float32 `json:"drone_roll" csv:"drone_lat" name:"drone_lat"`
	Pitch           float32 `json:"drone_pitch" csv:"drone_lat" name:"drone_lat"`
	Yaw             float32 `json:"drone_yaw" csv:"drone_lat" name:"drone_lat"`
